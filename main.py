...
if __name__=="__main__":
    ...
    parser.add_argument("data_path", help="Path of the data folder that contains Eval and Train")
    parser.add_argument("save_path", help="Path to save the tfrecords")
    parser.add_argument("--fmt",required=False,default='png',help =   "format of the image")
    parser.add_argument("--data_dim",required=False,default=256,help ="dimension to resize the images")
    parser.add_argument("--image_type",required=False,default='rgb',help ="type of image (grayscale,rgb,binary)")
